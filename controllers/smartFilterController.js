...
async function runChat(userInput, allProfiles) {
    ...
    const chat = model.startChat({
        ...
        history: [
            ...
            {
                role: "user",
                parts: [{ text: "now i will provide you with an array of skills, Or keywords what you have to do is you have to "+
                        "analyse all the profiles of people thoroughly and respond with names of those people who have"+
                        "skills that match the skills or Keywords matching any of their information like title, organization,name etc., that i am providing you in the input. If the person has even one matching skill"+
